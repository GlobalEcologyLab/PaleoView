...
bias_data_grids = [] # expected
for month_code in ['K', 'L', 'A', 'B', 'C'] :
    bias_data_grids.append(np.genfromtxt(path.join(directory, 'RelativeHumidity', 'Trace21_2.5x2.5_H'+month_code+'_Delta.txt')))
...
corrected_data_grids = (1 - (1 - bounded_data_grids4/100)**bias_data_grids4)*100
...
print '    Pass =', (corrected_data_grids == corrected_data_grids6).all()
...
data_helper.setClimateDataSource('local')
data_helper.setClimateDataDirectory(r'C:/Users/shaythorne/Desktop/PaleoView/Tests/NetCdfClimateData') # r'D:/Trace-21'
...
parameters = ['relative_humidity'] #'minimum_temperature', 'maximum_temperature', 'specific_humidity', 'precipitation', 'sea_level_pressure'] # DONE: 'mean_temperature', 
intervals = [[1950-22000, 1950-15000], [1950-15000, 1950-10000], [1950-10000, 1950-5000], [1950-5000, 1989]] # 
for parameter in parameters :
    for interval in intervals :
        data_helper.generateNetCdfClimateData(parameter, interval[0], interval[1], zlib=True)
