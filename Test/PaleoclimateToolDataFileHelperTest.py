...
##data_helper.setClimateDataUrl('https://dl.dropboxusercontent.com/sh/upmj85imokepgts/')
##
...
##data_helper.setClimateDataUrl('https://dl.dropboxusercontent.com/sh/upmj85imokepgts_BAD/')
##try :
